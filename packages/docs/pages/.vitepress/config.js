...
export default defineConfig({
  ...
  themeConfig: {
    ...
    socialLinks: [
      { icon: 'github', link: 'https://github.com/RanaN92/LinkHub' },
      { icon: 'twitter', link: 'https://github.com/RanaN92/LinkHub' },
      { icon: 'discord', link: 'https://discord.gg/dJSah9CVrC' },
    ],
    editLink: {
      pattern:
        'https://github.com/RanaN92/LinkHub/edit/main/packages/docs/pages/:path',
  ...
  async transformHead(ctx) {
    ...
    return [
      ...
      [
        ...
        {
          defer: true,
          'data-domain': 'LinkHub.io',
          'data-api': 'https://LinkHub.io/data/api/event',
          src: 'https://LinkHub.io/data/js/script.js',
        },
      ],
    ];
  },
